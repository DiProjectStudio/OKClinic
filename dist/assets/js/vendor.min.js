...
function onTouchStart(event) {
    ...
    if (document2.activeElement && document2.activeElement.matches(data.focusableElements) && document2.activeElement !== targetEl && (e2.pointerType === "mouse" || e2.pointerType !== "mouse" && !targetEl.matches(data.focusableElements))) document2.activeElement.blur();
...
function onTouchMove(event) {
    ...
    if (document2.activeElement && document2.activeElement.matches(data.focusableElements) && document2.activeElement !== e2.target && e2.pointerType !== "mouse") document2.activeElement.blur();
...
function Grid(_ref) {
    ...
    const unsetSlides = () => {
        if (swiper.slides) swiper.slides.forEach((slide2 => {
...
export { Grid as G, Inputmask as I, Navigation as N, Oe as O, Swiper as S, _default as _ };
